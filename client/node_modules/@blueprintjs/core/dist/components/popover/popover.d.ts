...
export declare class Popover extends AbstractComponent<IPopoverProps, IPopoverState> {
    ...
    private setOpenStateByPropCallback(isOpen, e?, timeout?);
    private setOpenStateDirectly(isOpen);
    private isElementInPopover(element);
    private isHoverInteractionKind();
    private checkDOMForDarkTheme();
}
export declare const PopoverFactory: React.ComponentFactory<IPopoverProps, Popover>;
