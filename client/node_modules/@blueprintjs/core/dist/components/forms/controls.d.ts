...
export declare class Control<P extends IControlProps> extends React.Component<P, {}> {
    protected renderControl(type: "checkbox" | "radio", typeClassName: string, inputRef?: P["inputRef"]): JSX.Element;
}
...
export declare const CheckboxFactory: React.ComponentFactory<Readonly<{
    children?: React.ReactNode;
}> & Readonly<ICheckboxProps>, Checkbox>;
export declare const SwitchFactory: React.ComponentFactory<Readonly<{
    children?: React.ReactNode;
}> & Readonly<ISwitchProps>, Switch>;
export declare const RadioFactory: React.ComponentFactory<Readonly<{
    children?: React.ReactNode;
}> & Readonly<IRadioProps>, Radio>;
