...
import { AbstractComponent, Classes, Keys, Position, removeNonHTMLProps, Utils, } from "../../common";
...
var NumericInput = (function (_super) {
    ...
    NumericInput.prototype.render = function () {
        ...
        var inputGroupHtmlProps = removeNonHTMLProps(this.props, [
        ...
        var inputGroup = (React.createElement(InputGroup, tslib_1.__assign({ autoComplete: "off" }, inputGroupHtmlProps, { className: classNames((_b = {}, _b[Classes.LARGE] = large, _b)), intent: this.props.intent, inputRef: this.inputRef, key: "input-group", leftIconName: this.props.leftIconName, onFocus: this.handleInputFocus, onBlur: this.handleInputBlur, onChange: this.handleInputChange, onKeyDown: this.handleInputKeyDown, onKeyPress: this.handleInputKeyPress, onPaste: this.handleInputPaste, value: this.state.value })));
        ...
        if (buttonPosition === "none" || buttonPosition === null) {
            ...
            var buttonGroup = (React.createElement("div", { key: "button-group", className: classNames(Classes.BUTTON_GROUP, Classes.VERTICAL, Classes.FIXED) },
                incrementButton,
                decrementButton));
            var inputElems = buttonPosition === Position.LEFT ? [buttonGroup, inputGroup] : [inputGroup, buttonGroup];
            var classes = classNames(Classes.NUMERIC_INPUT, Classes.CONTROL_GROUP, (_c = {},
    ...
    NumericInput.prototype.renderButton = function (key, iconName, onClick) {
        ...
        return (React.createElement(Button, { disabled: this.props.disabled || this.props.readOnly, iconName: iconName, intent: this.props.intent, key: key, onBlur: this.handleButtonBlur, onClick: onClick, onFocus: this.handleButtonFocus, onKeyUp: onKeyUp }));
    };
...
export { NumericInput };
export var NumericInputFactory = React.createFactory(NumericInput);
