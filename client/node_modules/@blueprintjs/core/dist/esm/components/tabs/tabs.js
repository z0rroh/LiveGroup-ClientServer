...
var Tabs = (function (_super) {
    ...
    Tabs.prototype.componentDidMount = function () {
        var _this = this;
        var selectedTab = findDOMNode(this.refs["tabs-" + this.state.selectedTabIndex]);
    ...
    Tabs.prototype.componentDidUpdate = function (_, prevState) {
        ...
        if (newIndex !== prevState.selectedTabIndex) {
            var tabElement_1 = findDOMNode(this.refs["tabs-" + newIndex]);
    ...
    Tabs.prototype.focusTab = function (index) {
        var ref = "tabs-" + index;
        var tab = findDOMNode(this.refs[ref]);
        tab.focus();
    };
