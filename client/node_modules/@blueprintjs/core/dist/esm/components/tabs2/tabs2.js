...
export var Expander = function () { return React.createElement("div", { className: "pt-flex-expander" }); };
...
var Tabs2 = (function (_super) {
    ...
    function Tabs2(props) {
        ...
        _this.renderTabTitle = function (tab) {
            var id = tab.props.id;
            return (React.createElement(TabTitle, tslib_1.__assign({}, tab.props, { parentId: _this.props.id, onClick: _this.handleTabClick, selected: id === _this.state.selectedTabId })));
        };
...
export { Tabs2 };
export var Tabs2Factory = React.createFactory(Tabs2);
...
function isTab(child) {
    return child != null && child.type === Tab2;
}
