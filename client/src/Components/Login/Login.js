              ...
              <div className="Login-Card card-panel">
                <Switch>
                  <Route exact path="/auth/login"
                    component={() => <SignInForm addToast={addToast} history={history} loginServer={loginServer}/>}/>
                  <Route exact path="/auth/registrar"
                    component={() => <SignUpForm addToast={addToast} history={history} SignupServer={SignupServer}/>}/>
